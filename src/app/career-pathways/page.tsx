...
export default function CareerPathwaysPage() {
  ...
  const [userProfile, setUserProfile] = useState<SarthiUserProfile | null>(null)
    ...
    try {
      ...
      const samplePathways: CareerPathway[] = [
        ...
        },
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech IT/Cybersecurity', 'Certifications (CEH, CISSP)', 'M.Tech (Optional)'],
          skills_required: ['Network Security', 'Risk Assessment', 'Incident Response', 'Ethical Hacking'],
          job_opportunities: ['Security Analyst', 'Penetration Tester', 'Security Architect', 'CISO'],
        ...
        },
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech Computer Science', 'M.Tech AI/ML', 'PhD (Research)'],
          skills_required: ['Python', 'Machine Learning', 'Deep Learning', 'Statistics'],
          job_opportunities: ['ML Engineer', 'AI Researcher', 'Data Scientist', 'AI Product Manager'],
        ...
        },
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech Computer Science', 'Cloud Certifications', 'Experience'],
          skills_required: ['Cloud Computing', 'CI/CD', 'Containerization', 'Infrastructure as Code'],
          job_opportunities: ['DevOps Engineer', 'Site Reliability Engineer', 'Cloud Architect', 'Platform Engineer'],
        ...
        },
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech + MBA', 'Business Experience', 'Product Certifications'],
          skills_required: ['Strategic Thinking', 'User Research', 'Data Analysis', 'Leadership'],
          job_opportunities: ['Product Manager', 'Senior PM', 'Product Director', 'CPO'],
        ...
        },
        {
          ...
          stream: 'medical',
          education_requirements: ['B.Sc Nursing', 'M.Sc Nursing (Optional)', 'Registration'],
          skills_required: ['Patient Care', 'Medical Knowledge', 'Compassion', 'Communication'],
          job_opportunities: ['Staff Nurse', 'Nurse Manager', 'Nurse Educator', 'Public Health Nurse'],
        ...
        },
        {
          ...
          stream: 'medical',
          education_requirements: ['B.Pharm', 'M.Pharm (Optional)', 'Registration'],
          skills_required: ['Pharmaceutical Knowledge', 'Attention to Detail', 'Communication', 'Ethics'],
          job_opportunities: ['Community Pharmacist', 'Hospital Pharmacist', 'Clinical Pharmacist', 'Pharmaceutical Researcher'],
        ...
        },
        {
          ...
          stream: 'medical',
          education_requirements: ['BPT', 'MPT (Specialization)', 'Registration'],
          skills_required: ['Anatomy Knowledge', 'Manual Therapy', 'Communication', 'Patience'],
          job_opportunities: ['Clinical Physiotherapist', 'Sports Physiotherapist', 'Pediatric Physiotherapist', 'Rehabilitation Specialist'],
        ...
        },
        {
          ...
          stream: 'commerce',
          education_requirements: ['MBA Finance', 'CFA (Optional)', 'Strong Academic Record'],
          skills_required: ['Financial Modeling', 'Analytical Skills', 'Communication', 'Networking'],
          job_opportunities: ['Analyst', 'Associate', 'VP', 'Managing Director'],
        ...
        },
        {
          ...
          stream: 'commerce',
          education_requirements: ['MBA from Top Tier', 'Strong Problem Solving', 'Industry Experience'],
          skills_required: ['Strategic Thinking', 'Problem Solving', 'Communication', 'Data Analysis'],
          job_opportunities: ['Business Analyst', 'Consultant', 'Senior Consultant', 'Partner'],
          salary_range: { min: 1000000, max: 4000000, currency: 'INR' },
          growth_prospects: 'High',
        ...
        },
        {
          ...
          stream: 'commerce',
          education_requirements: ['BBA/MBA Marketing', 'Digital Marketing Certifications', 'Experience'],
          skills_required: ['SEO/SEM', 'Social Media', 'Analytics', 'Content Creation'],
          job_opportunities: ['Digital Marketing Specialist', 'Marketing Manager', 'Growth Hacker', 'CMO'],
        ...
        },
        {
          ...
          stream: 'science',
          education_requirements: ['PhD in Relevant Field', 'Research Experience', 'Publications'],
          skills_required: ['Research Methodology', 'Critical Thinking', 'Data Analysis', 'Communication'],
          job_opportunities: ['Research Scientist', 'Senior Scientist', 'Research Director', 'Professor'],
        ...
        },
        {
          ...
          stream: 'science',
          education_requirements: ['B.Sc Environmental Science', 'M.Sc/M.Tech', 'PhD (Optional)'],
          skills_required: ['Environmental Knowledge', 'Data Analysis', 'Problem Solving', 'Communication'],
          job_opportunities: ['Environmental Consultant', 'Research Scientist', 'Policy Analyst', 'Environmental Manager'],
          salary_range: { min: 400000, max: 1200000, currency: 'INR' },
          growth_prospects: 'High',
        ...
        },
        {
          ...
          stream: 'arts',
          education_requirements: ['B.F.A/B.Des', 'Portfolio', 'Software Skills'],
          skills_required: ['Creativity', 'Design Software', 'Typography', 'Color Theory'],
          job_opportunities: ['Graphic Designer', 'UI/UX Designer', 'Art Director', 'Creative Director'],
        ...
        },
        {
          ...
          stream: 'arts',
          education_requirements: ['B.A. English/Journalism', 'Writing Portfolio', 'SEO Knowledge'],
          skills_required: ['Writing', 'Research', 'SEO', 'Creativity'],
          job_opportunities: ['Content Writer', 'Copywriter', 'Content Manager', 'Editor'],
          salary_range: { min: 250000, max: 800000, currency: 'INR' },
          growth_prospects: 'High',
        ...
        // Emerging Fields
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech Computer Science', 'Blockchain Certifications', 'Experience'],
          skills_required: ['Solidity', 'Smart Contracts', 'Cryptography', 'Web3'],
          job_opportunities: ['Blockchain Developer', 'Smart Contract Developer', 'DeFi Developer', 'Blockchain Architect'],
        ...
        },
        {
          ...
          stream: 'arts',
          education_requirements: ['B.Des/B.F.A', 'Design Portfolio', 'User Research Skills'],
          skills_required: ['User Research', 'Prototyping', 'Design Tools', 'Psychology'],
          job_opportunities: ['UX Designer', 'UI Designer', 'Product Designer', 'Design Lead'],
        ...
        },
        {
          ...
          description: 'Help organizations implement sustainable business practices',
          stream: 'science',
          education_requirements: ['B.Sc Environmental Science', 'MBA Sustainability', 'Certifications'],
          skills_required: ['Environmental Knowledge', 'Business Acumen', 'Analytics', 'Communication'],
          job_opportunities: ['Sustainability Consultant', 'ESG Analyst', 'Sustainability Manager', 'Chief Sustainability Officer'],
          salary_range: { min: 600000, max: 1500000, currency: 'INR' },
          growth_prospects: 'Very High',
        ...
        },
        {
          ...
          description: 'Develop and implement digital health solutions and telemedicine',
          stream: 'medical',
          education_requirements: ['Medical Degree + Tech Skills', 'Health Informatics', 'Certifications'],
          skills_required: ['Medical Knowledge', 'Technology', 'Data Analysis', 'Patient Care'],
          job_opportunities: ['Digital Health Consultant', 'Telemedicine Specialist', 'Health Tech Product Manager', 'Chief Medical Officer'],
          salary_range: { min: 800000, max: 2000000, currency: 'INR' },
          growth_prospects: 'Very High',
        ...
        // Traditional & Skilled Trades
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech Civil Engineering', 'M.Tech (Optional)', 'Professional License'],
          skills_required: ['Structural Design', 'Project Management', 'CAD Software', 'Problem Solving'],
          job_opportunities: ['Site Engineer', 'Project Manager', 'Structural Engineer', 'Construction Manager'],
          salary_range: { min: 400000, max: 1200000, currency: 'INR' },
          growth_prospects: 'Medium',
          related_exams: ['JEE Main', 'GATE'],
          duration: '4-5 years',
        ...
        },
        {
          ...
          stream: 'engineering',
          education_requirements: ['B.Tech Mechanical Engineering', 'M.Tech (Optional)', 'Industry Experience'],
          skills_required: ['CAD/CAM', 'Manufacturing', 'Thermodynamics', 'Problem Solving'],
          job_opportunities: ['Design Engineer', 'Manufacturing Engineer', 'Project Engineer', 'Engineering Manager'],
          salary_range: { min: 400000, max: 1000000, currency: 'INR' },
          growth_prospects: 'Medium',
          related_exams: ['JEE Main', 'GATE'],
          duration: '4-5 years',
        ...
        },
        {
          ...
          stream: 'vocational',
          education_requirements: ['ITI Electrical', 'Diploma in Electrical', 'Licensing'],
          skills_required: ['Electrical Knowledge', 'Safety Procedures', 'Problem Solving', 'Manual Dexterity'],
          job_opportunities: ['Electrician', 'Electrical Technician', 'Maintenance Electrician', 'Electrical Contractor'],
        ...
        },
        {
          id: '28',
          title: 'Chef',
          description: 'Prepare and cook food in restaurants, hotels, and other establishments',
          stream: 'vocational',
          education_requirements: ['Culinary Arts Diploma', 'Hotel Management', 'Apprenticeship'],
          skills_required: ['Cooking Techniques', 'Food Safety', 'Creativity', 'Time Management'],
          job_opportunities: ['Line Cook', 'Sous Chef', 'Head Chef', 'Executive Chef'],
          salary_range: { min: 250000, max: 800000, currency: 'INR' },
          growth_prospects: 'Medium',
      ...
      <nav className="border-b bg-white/90 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/comprehensive-assessment" className="text-gray-600 hover:text-primary transition-all duration-200 hover:scale-105 font-medium">
              AI Assessment
            </Link>
            <Link href="/career-pathways" className="text-primary font-semibold transition-all duration-200 hover:scale-105">
              Career Paths
            </Link>
            ...
            {user ? (
              <>
                ...
                <Button variant="outline" className="hover:scale-105 transition-all duration-200 border-2 hover:border-primary hover:bg-primary/5" asChild>
                  <Link href={`/dashboard/${profile?.role || 'student'}`}>Dashboard</Link>
                </Button>
                <Button 
                  variant="outline" 
                  onClick={signOut}
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90 leading-relaxed">
              ...
              to make informed decisions about your future with AI-powered insights.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="relative overflow-hidden text-lg px-8 py-4 bg-white text-blue-800 hover:bg-gray-50 transition-all duration-500 hover:scale-105 shadow-2xl hover:shadow-3xl group border-2 border-white/20" asChild>
                <Link href="/quiz" className="flex items-center gap-3 relative z-10">
      ...
      <div className="container mx-auto px-4 py-12 -mt-8 relative z-10">
        ...
        <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-white/20 mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Find Your Perfect Career</h2>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700">Take our AI-powered quiz to get personalized career guidance with ROI analysis</p>
                  </div>
                </div>
        ...
        {/* Kiro AI Stream Comparison */}
        {showComparison && userProfile && (
          <div className="mb-8">
            <StreamComparison 
              userProfile={userProfile}
              streamsToCompare={selectedStream ? [selectedStream] : ['science', 'commerce', 'arts']}
            />
          </div>
        )}
          ...
          <Card className="mb-8 border-orange-200 bg-orange-50">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-orange-700 mb-4">
                Take our aptitude quiz to unlock personalized stream comparison with ROI analysis, 
                parental guidance, and J&K-specific recommendations.
              </p>
              <Button asChild>
            ...
            >
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-bold ${getStreamColor(pathway.stream)}`}>
                    {pathway.stream}
                  </span>
                </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{pathway.duration}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">₹{pathway.salary_range.min/100000}L-{pathway.salary_range.max/100000}L</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${getDifficultyColor(pathway.difficulty)}`}>
                      {pathway.difficulty}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <TrendingUp className="h-4 w-4 text-green-500" />
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${getGrowthColor(pathway.growth_prospects)}`}>
                ...
                {/* Skills Preview */}
                <div>
                  <p className="text-sm font-medium text-gray-700 mb-3">Key Skills:</p>
                  <div className="flex flex-wrap gap-2">
                    {pathway.skills_required.slice(0, 3).map((skill, skillIndex) => (
                      <span key={skillIndex} className="px-3 py-1 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 text-sm rounded-full font-medium">
                        {skill}
                      </span>
                    ))}
                ...
                <Button className="w-full h-12 text-lg font-semibold bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary transition-all duration-300 group-hover:scale-105" variant="default">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-white/20">
            <div className="p-8">
              <div className="flex justify-between items-start mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-600">{selectedPathway.description}</p>
                  </div>
                </div>
                <button
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-3">
                      {selectedPathway.skills_required.map((skill, index) => (
                        <span key={index} className="px-4 py-2 bg-gradient-to-r from-purple-100 to-indigo-100 text-purple-800 text-sm rounded-full font-medium">
                          {skill}
                        </span>
                      ))}
                    </div>
                ...
                <Card className="border-0 bg-white/80 backdrop-blur-sm shadow-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                      ...
                      <span className="font-bold text-gray-900">{selectedPathway.duration}</span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                      <span className="text-gray-600 font-medium">Difficulty:</span>
                      <span className={`px-3 py-1 rounded-full text-sm font-bold ${getDifficultyColor(selectedPathway.difficulty)}`}>
                        {selectedPathway.difficulty}
                      </span>
                    </div>
                    <div className="flex justify-between items-center p-3 bg-gray-50 rounded-xl">
                      <span className="text-gray-600 font-medium">Growth Prospects:</span>
                      <span className={`px-3 py-1 rounded-full text-sm font-bold ${getGrowthColor(selectedPathway.growth_prospects)}`}>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-3">
                      {selectedPathway.related_exams.map((exam, index) => (
                        <span key={index} className="px-4 py-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 text-sm rounded-full font-medium">
                          {exam}
                        </span>
                      ))}
                    </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Button asChild size="lg" className="h-14 text-lg font-bold bg-gradient-to-r from-primary to-blue-600 hover:from-blue-600 hover:to-primary transition-all duration-300 hover:scale-105">
                  <Link href="/quiz" className="flex items-center gap-3">
                    <Brain className="h-6 w-6" />
                    Take Aptitude Test
                  </Link>
                </Button>
                <Button variant="outline" asChild size="lg" className="h-14 text-lg font-bold border-2 hover:border-primary hover:bg-primary/5 transition-all duration-300 hover:scale-105">
                  <Link href="/colleges" className="flex items-center gap-3">
                    <MapPin className="h-6 w-6" />
                    Find Colleges
                  </Link>
                ...
                <Button variant="outline" asChild size="lg" className="h-14 text-lg font-bold border-2 hover:border-primary hover:bg-primary/5 transition-all duration-300 hover:scale-105">
                  <Link href="/scholarships" className="flex items-center gap-3">
