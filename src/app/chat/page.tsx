...
export const metadata: Metadata = {
  ...
  description: 'Get personalized education guidance from AI Sarthi - your intelligent education counselor.',
};
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-100 text-sm">
                  Your intelligent education counselor is here to help you make informed decisions about your academic future.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="mt-4 text-gray-600 text-sm max-w-md">
                PathNiti is your comprehensive education platform providing AI-powered guidance, 
                college recommendations, and career counseling to help students make informed decisions.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><Link href="/comprehensive-assessment" className="text-gray-600 hover:text-primary text-sm">AI Assessment</Link></li>
                <li><Link href="/colleges" className="text-gray-600 hover:text-primary text-sm">Find Colleges</Link></li>
                <li><Link href="/scholarships" className="text-gray-600 hover:text-primary text-sm">Scholarships</Link></li>
                <li><Link href="/career-pathways" className="text-gray-600 hover:text-primary text-sm">Career Paths</Link></li>
              </ul>
            </div>
