...
export const metadata: Metadata = {
  ...
  description: 'Manage your college profile, courses, and student applications.',
}
...
export default async function CollegeDashboardPage() {
  ...
  const college = collegeProfile.colleges
      ...
      <nav className="bg-white border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-blue-600">College Dashboard</span>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{collegeData.courses?.length || 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{collegeData.notices?.length || 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          ...
          <TabsContent value="profile" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Button className="justify-start h-auto p-4" variant="outline">
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">Create new course offerings</p>
                    </div>
                  </Button>
                  <Button className="justify-start h-auto p-4" variant="outline">
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">Share important updates</p>
                    </div>
                  </Button>
                  <Button className="justify-start h-auto p-4" variant="outline">
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">Manage student applications</p>
                    </div>
                  </Button>
                  <Button className="justify-start h-auto p-4" variant="outline">
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500">Update college information</p>
                    </div>
                  </Button>
                </div>
              </CardContent>
            ...
            <CollegeProfileManager initialData={collegeData} />
          </TabsContent>
