...
export const metadata: Metadata = {
  ...
  description: 'Register your college on PathNiti to create a dynamic profile page and manage student applications.',
}
...
export default async function CollegeRegisterPage({ searchParams }: PageProps) {
  ...
  if (existingCollege) {
    redirect(`/colleges/${existingCollege.slug || existingCollege.id}?message=already-registered`)
  }
  ...
  const minimal = searchParams.minimal === 'true'
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            {isFromSignup ? (
              <a href={returnTo || '/auth/signup/college'} className="text-blue-600 hover:underline">
                ← Return to signup
              </a>
            ) : (
              <>
                Already registered? <a href="/colleges/dashboard" className="text-blue-600 hover:underline">
