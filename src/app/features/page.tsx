...
export default function FeaturesPage() {
  const features = [
    {
      ...
      description:
        "Comprehensive quiz to identify your strengths, interests, and suitable career paths",
      benefits: [
        "AI-powered analysis",
    ...
    },
    {
      ...
      description:
        "Discover nearby government colleges with detailed information about programs and admissions",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Never miss important deadlines for admissions, scholarships, and entrance exams",
      benefits: [
        "Smart notifications",
        "Deadline reminders",
        "Progress tracking",
    ...
    },
    {
      ...
      description:
        "Visualize your career journey from education to employment with detailed roadmaps",
      benefits: [
    ...
    },
    {
      ...
      title: "Scholarships",
      description:
        "Find and apply for government scholarships and financial aid opportunities",
      benefits: [
  ...
  const additionalFeatures = [
    ...
    },
    {
      ...
      title: "Mobile App",
      description:
        "Access PathNiti on the go with our native mobile application",
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      description:
        "Get instant notifications about new opportunities and deadlines",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            and career path, all in one comprehensive platform.
          </p>
        </div>
        ...
        <div className="relative rounded-lg mb-16 overflow-hidden">
          ...
          <div className="relative p-8 z-10 text-white">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-4xl font-bold mb-2 drop-shadow-[0_2px_8px_rgba(16,185,129,0.15)]">
                  10,000+
                </div>
