...
export function PathNitiLogoDetailed({ 
  ...
  return (
    <div className={`flex flex-col items-center ${className}`}>
      ...
      <div className={`${sizeClasses[size]} relative`}>
        ...
        >
          ...
          <g fill="#1A2B8C">
            ...
            {/* Tassel */}
            <line x1="30" y1="26" x2="28" y2="20" stroke="#1A2B8C" strokeWidth="1.5" />
            ...
            <line x1="45" y1="55" x2="45" y2="73" stroke="#1A2B8C" strokeWidth="0.8" />
            <line x1="48" y1="55" x2="48" y2="73" stroke="#1A2B8C" strokeWidth="0.8" />
            <line x1="51" y1="55" x2="51" y2="73" stroke="#1A2B8C" strokeWidth="0.8" />
            <line x1="54" y1="55" x2="54" y2="73" stroke="#1A2B8C" strokeWidth="0.8" />
            <line x1="57" y1="55" x2="57" y2="73" stroke="#1A2B8C" strokeWidth="0.8" />
          </g>
      ...
      {/* Text */}
      {showText && (
        <div className={`${textSizeClasses[size]} font-bold text-[#1A2B8C] mt-2`}>
          PathNiti
        </div>
      )}
    </div>
