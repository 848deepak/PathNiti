 ...
 */
export function hasRole(profile: UserProfile | null, role: 'student' | 'admin' | 'college'): boolean {
 ...
 */
export function getRequiredRole(pathname: string): 'student' | 'admin' | 'college' | null {
  if (pathname.startsWith('/admin') || pathname.startsWith('/dashboard/admin')) {
    return 'admin'
  }
  
  if (pathname.startsWith('/colleges/dashboard') || pathname.startsWith('/colleges/manage') || pathname.startsWith('/dashboard/college')) {
    return 'college'
  }
